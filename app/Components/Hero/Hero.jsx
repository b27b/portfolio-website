    ...
    <main className="font-[family-name:var(--font-reddit-mono)] h-[450px]">
      <div className="relative">
        <div className="flex justify-center mt-48">
          <Image src={Felt} alt="" className="absolute z-40 -top-96 w-full" />
          ...
          <section className="absolute z-20 mt-64">
            <div className="relative flex justify-center items-center">
              <p className="text-lightcolour w-1120 px-12 absolute text-xl pb-2 text-center">
